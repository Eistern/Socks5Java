...
public class ConfigService {
    private static volatile SnakesProto.GameConfig config = null;

    public static SnakesProto.GameConfig getSystemConfig() throws ClassNotFoundException, IOException {
        if (config == null) {
            synchronized (Main.class.getClassLoader().loadClass("net.fit.ConfigService")) {
                if (config == null) {
